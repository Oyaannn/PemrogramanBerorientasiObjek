...
# Example
hospital = Hospital("Sejahtera Hospital")

dep1 = Department("Orthopaedics")
dep2 = Department("Anaesthesiology")

hospital.add_department(dep1)
hospital.add_department(dep2)

doc1 = Doctor(1, "Dr. Arroyan", "Orthopaedics")
doc2 = Doctor(2, "Dr. Kiboy", "Anaesthesiology")

dep1.add_doctor(doc1)
dep2.add_doctor(doc2)

pat1 = Patient(1, "Asep", 30)
pat2 = Patient(2, "Putri", 25)

doc1.add_patient(pat1)
doc2.add_patient(pat2)

pat1.add_medical_record(1, "HIV", "Repent")
pat2.add_medical_record(2, "Fever", "Ibuprofen")
